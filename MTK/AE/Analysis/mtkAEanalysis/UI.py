...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        font.setWeight(50)
        self.project_type_selector.setFont(font)
        self.project_type_selector.setStyleSheet("font:18px ;\n"
"text-align:center;")
        self.project_type_selector.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        self.project_type_selector.setObjectName("project_type_selector")
        self.project_type_selector.addItem("")
        self.horizontalLayout.addWidget(self.project_type_selector)
...
"color:rgb(255, 255, 255);")
        ...
        self.excel_selector = QtWidgets.QComboBox(Form)
        self.excel_selector.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.excel_selector.setObjectName("excel_selector")
        self.excel_selector.addItem("")
        self.verticalLayout.addWidget(self.excel_selector)
...
"color:rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.project_type_selector.setItemText(0, _translate("Form", "選擇專案"))
        self.load_exif_btn.setText(_translate("Form", "選擇照片、exif 資料夾"))
        self.load_code_btn.setText(_translate("Form", "選擇 code"))
        self.excel_selector.setItemText(0, _translate("Form", "選擇excel"))
