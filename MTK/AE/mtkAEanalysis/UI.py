...
"color:rgb(255, 255, 255);")
        ...
        self.excel_selecter = QtWidgets.QComboBox(Form)
        self.excel_selecter.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.excel_selecter.setObjectName("excel_selecter")
        self.excel_selecter.addItem("")
        self.verticalLayout.addWidget(self.excel_selecter)
...
"color:rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.excel_selecter.setItemText(0, _translate("Form", "選擇excel"))
